        ...
        <div className="pb-20">
            ...
            <div className="text-center mb-8">
                <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">
                    音声から<span className="text-orange-500">コンテンツ</span>を作成
                </h1>
                <p className="text-gray-500 text-base sm:text-lg">
                    アップロードするだけで概要欄・タイトル・X投稿文を自動生成
                </p>
            </div>

            {/* Profile Status */}
            {!profile?.channelDescription && status === 'idle' && (
                <div className="alert-info rounded-lg p-4 mb-6 flex items-center justify-between">
                    <span>💡 設定画面でプロフィールを設定すると、概要欄にテンプレートが適用されます</span>
                    <a href="/settings" className="text-orange-600 hover:underline ml-2 font-medium">設定へ →</a>
                </div>
            )}
